...
% Unroll parameters 
epsilon_init1=1;epsilon_init2=1;epsilon_init3=1;epsilon_init4=1;

Theta1=randInitWeights(input_layer_size,hidden_layer_size,epsilon_init1);
Theta2=randInitWeights(hidden_layer_size,hidden_layer_size2,epsilon_init2);
Theta3=randInitWeights(hidden_layer_size2,hidden_layer_size3,epsilon_init3);
Theta4=randInitWeights(hidden_layer_size3,num_labels,epsilon_init4);
...
J = nnCostFunction_multi(nn_params, input_layer_size, hidden_layer_size, ...
...
debug_J  = nnCostFunction_multi(nn_params, input_layer_size, hidden_layer_size, ...
                    hidden_layer_size2, hidden_layer_size3, ...
                   num_labels, X, y, lambda);
...
options = optimset('MaxIter', iteration_num);
...
costFunction = @(p) nnCostFunction_multi(p, input_layer_size, hidden_layer_size, ...
                    hidden_layer_size2, hidden_layer_size3, ...
                                   num_labels, X, y, lambda);
...
pred = predict_multi(Theta1, Theta2, Theta3, Theta4, X);
